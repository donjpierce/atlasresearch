...
//L1 Algorithm resoltuions in ZeroBias
		...
		l1zb_1->GetYaxis()->SetTitle("#sigma of Fit for L1 [GeV]");
	...
	//l1kf Algorithm resoltuions in ZeroBias and Muons
		...
		l1kfzb_1->GetYaxis()->SetTitle("#sigma of Fit for L1 KF [GeV]");
		...
		mhtl1zb_1->GetYaxis()->SetTitle("#sigma of Fit for MHT L1 [GeV]");
		...
		mhtl1kfzb_1->GetYaxis()->SetTitle("#sigma of Fit for MHTKF L1 [GeV]");
